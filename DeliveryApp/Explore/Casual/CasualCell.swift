...
class CasualLunchCell: UICollectionViewCell {
    let cellId = "cellId"
...
extension CasualLunchCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! CasualCustomCell
        return cell
    }
    ...
    private func registerWork(){
        collectionView.register(CasualCustomCell.self, forCellWithReuseIdentifier: cellId)
        
    }
}

class CasualCustomCell: UICollectionViewCell {
